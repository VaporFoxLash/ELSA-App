...
public class EventsActivity extends AppCompatActivity{
    ...
    private EditText mEditTextFileName, mEditTextFilePost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextFilePost = findViewById(R.id.editText_post);
        ...
        mTextViewShowUploads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EventsActivity.this, ImageActivity.class);
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),
                                            downloadUri.toString(), mEditTextFilePost.getText().toString().trim());
